...
const FormSchema = z.object({
  id: z.string(),//Zod already throws an error if the customer field is empty as it expects a type string
  customerId: z.string({
    invalid_type_error: 'Please select a customer.',
  }),
  amount: z.coerce. //it'll default to zero if the string is empty
  ...
  status: z.enum(['pending', 'paid'],{//Zod already throws an error if the status field is empty as it expects "pending" or "paid"
